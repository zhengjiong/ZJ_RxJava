 ...
 */
public class BindActivityDemo1Activity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bind_activity_demo_1);
     ...
     * 被观察者onNext("call 2")和onCompleted()之后不会再次进入观察者的onNext和onError和oncompleted方法,
     ...
     */
    private void test1() {
        AppObservable.bindActivity(BindActivityDemo1Activity.this, blockMainThread())
